  ...
  return (
    ...
    >
      <div 
        ...
        className="flex flex-row items-center gap-3 px-3 py-3 bg-card border-b border-border/40 last:border-b-0 hover:bg-muted/40 transition-colors cursor-pointer group">
